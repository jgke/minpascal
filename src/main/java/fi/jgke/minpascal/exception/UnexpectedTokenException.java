...
public class UnexpectedTokenException extends RuntimeException {
    public UnexpectedTokenException(Token token, TokenType type) {
        super("Unexpected token: " + token.getType() + ", expected " + type + " near " + token.getPosition());
    }
    public UnexpectedTokenException(Token token, List<TokenType> types) {
        super("Unexpected token: " + token.getType() + ", expected any of: " + types + " near " + token.getPosition());
    }
}
